#!/usr/bin/env bash
# Interactive installer for an ext4-based NixOS system.
# - Prompts for timezone, keymap, hostname, username
# - Lets user select target disk
# - Partitions (GPT: 1GiB ESP + rest ext4)
...
${HASH_LINE:+${HASH_LINE}}
  ...
  environment.systemPackages = with pkgs; [
    git ncftp htop btop pciutils e2fsprogs wget curl
